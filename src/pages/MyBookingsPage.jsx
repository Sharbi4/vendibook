...
export function MyBookingsPage() {
  ...
  return (
    <div className="max-w-6xl mx-auto px-4 py-8">
      <SectionHeader title="My Bookings" subtitle="Track your rental and purchase requests" />
      ...
      {isLoading ? (
        ...
        <div className="space-y-4">
          {bookings.map(booking => (
            <div
              key={booking.id}
              className="border rounded-lg p-6 bg-white hover:shadow-lg transition cursor-pointer"
