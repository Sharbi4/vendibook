...
function ClerkSignUpForm() {
    ...
    try {
      ...
      await signUp.create({
        ...
        unsafeMetadata: {
          ...
          agreedToTerms: formValues.agree
        }
      });
      ...
      console.error('Clerk signUp.create error:', error);
  ...
  const handleCodeSubmit = async (event) => {
    ...
    if (code.length < 6) {
      setBannerError('Please enter the 6-digit verification code.');
      return;
    }
    ...
    try {
      ...
      if (result.status === 'complete') {
        ...
        console.warn('Sign-up not complete, status:', result.status, result);
        setBannerError('Additional verification is required. Please check your email or contact support.');
      }
    } catch (error) {
  ...
  return (
    <SignUpLayout>
      ...
      <form
        className="space-y-6"
        onSubmit={awaitingVerification ? handleCodeSubmit : handleSubmit}
        noValidate
      >
        <div className="grid gap-4 sm:grid-cols-2">
          <div>
            ...
            <input
              ...
              className={`mt-2 w-full rounded-2xl border px-4 py-3 text-base text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.firstName
          ...
          <div>
            ...
            <input
              ...
              type="text"
              disabled={awaitingVerification}
              className={`mt-2 w-full rounded-2xl border px-4 py-3 text-base text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.lastName
                ? 'border-rose-400/60 bg-rose-500/5 focus:border-rose-400 focus:ring-rose-400/30'
                : 'border-white/15 bg-white/5 focus:border-orange-400 focus:ring-orange-400/40'
                }`}
              placeholder="Raghav"
        ...
        <div>
          ...
          <input
            ...
            type="text"
            disabled={awaitingVerification}
            className={`mt-2 w-full rounded-2xl border px-4 py-3 text-base text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.username
              ? 'border-rose-400/60 bg-rose-500/5 focus:border-rose-400 focus:ring-rose-400/30'
              : 'border-white/15 bg-white/5 focus:border-orange-400 focus:ring-orange-400/40'
              }`}
        ...
        <div className="space-y-4">
          <div>
            ...
            <input
              ...
              type="email"
              disabled={awaitingVerification}
              className={`mt-2 w-full rounded-2xl border px-4 py-3 text-base text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.email
                ? 'border-rose-400/60 bg-rose-500/5 focus:border-rose-400 focus:ring-rose-400/30'
                : 'border-white/15 bg-white/5 focus:border-orange-400 focus:ring-orange-400/40'
                }`}
          ...
          <div>
            ...
            <input
              ...
              type="password"
              disabled={awaitingVerification}
              className={`mt-2 w-full rounded-2xl border px-4 py-3 text-base text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.password
                ? 'border-rose-400/60 bg-rose-500/5 focus:border-rose-400 focus:ring-rose-400/30'
                : 'border-white/15 bg-white/5 focus:border-orange-400 focus:ring-orange-400/40'
                }`}
    ...
    <SignUpLayout>
      <div className="space-y-4 rounded-2xl border border-amber-400/30 bg-amber-400/10 p-5">
        <p className="text-sm text-amber-100">
          Clerk authentication is currently disabled. Add{' '}
          <code className="font-mono">VITE_CLERK_PUBLISHABLE_KEY</code> and{' '}
          <code className="font-mono">VITE_CLERK_FRONTEND_API</code> to your environment, restart the dev server, and
          refresh this page to use the real sign-up flow.
        </p>
        <ul className="list-disc space-y-1 pl-5 text-sm text-amber-50/90">
          <li>Visit the Clerk dashboard to copy your keys.</li>
          <li>
            Update <code className="font-mono">.env.local</code> (or deployment env vars) with those values.
          </li>
          <li>
            Re-run <code className="font-mono">npm run dev</code> so Vite picks up the changes.
          </li>
        </ul>
      </div>
    </SignUpLayout>
...
//               type="text"
//               disabled={awaitingVerification}
//               className={`mt-2 w-full rounded-2xl border px-4 py-3 text-base text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.firstName ? 'border-rose-400/60 bg-rose-500/5 focus:border-rose-400 focus:ring-rose-400/30' : 'border-white/15 bg-white/5 focus:border-orange-400 focus:ring-orange-400/40'
//                 }`}
//               placeholder="Jordan"
//               value={formValues.firstName}
//               onChange={updateField}
...
//               type="text"
//               disabled={awaitingVerification}
//               className={`mt-2 w-full rounded-2xl border px-4 py-3 text-base text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.lastName ? 'border-rose-400/60 bg-rose-500/5 focus:border-rose-400 focus:ring-rose-400/30' : 'border-white/15 bg-white/5 focus:border-orange-400 focus:ring-orange-400/40'
//                 }`}
//               placeholder="Rivera"
//               value={formValues.lastName}
//               onChange={updateField}
...
//               type="email"
//               disabled={awaitingVerification}
//               className={`mt-2 w-full rounded-2xl border px-4 py-3 text-base text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.email ? 'border-rose-400/60 bg-rose-500/5 focus:border-rose-400 focus:ring-rose-400/30' : 'border-white/15 bg-white/5 focus:border-orange-400 focus:ring-orange-400/40'
//                 }`}
//               placeholder="you@vendibook.com"
//               value={formValues.email}
//               onChange={updateField}
...
//               type="password"
//               disabled={awaitingVerification}
//               className={`mt-2 w-full rounded-2xl border px-4 py-3 text-base text-white placeholder:text-slate-400 focus:outline-none focus:ring-2 ${errors.password ? 'border-rose-400/60 bg-rose-500/5 focus:border-rose-400 focus:ring-rose-400/30' : 'border-white/15 bg-white/5 focus:border-orange-400 focus:ring-orange-400/40'
//                 }`}
//               placeholder="Create a secure password"
//               value={formValues.password}
//               onChange={updateField}
